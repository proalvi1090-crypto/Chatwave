      ...
      >
        <section className="auth-hero relative hidden overflow-hidden p-10 text-white lg:block">
          <motion.div
            ...
            className="pointer-events-none absolute -right-10 -top-10 h-56 w-56 rounded-full bg-sky-400/20 blur-3xl"
          />
          <motion.div
          ...
          <motion.div className="relative z-10 h-full w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.55 }}>
            ...
            />
            <motion.div
              animate={{ scale: [1, 1.04, 1], rotate: [0, 1.2, 0] }}
              transition={{ duration: 7.5, repeat: Infinity, ease: "easeInOut" }}
              className="absolute inset-20 rounded-[1.5rem] border border-emerald-300/25"
            />
            <motion.div
              animate={{ rotate: 360 }}
